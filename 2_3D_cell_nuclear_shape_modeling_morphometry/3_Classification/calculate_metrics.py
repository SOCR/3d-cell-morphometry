...
def main(res_file_lst, output_file):
    ...
    f.write("Image level prediction: %s, Accuracy: %0.2f, Avg. probability: %0.2f\n\nProbabilities per cell:\n" % (label, acc, avg_prob))
    for res in results:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Collecting results of cell type classification')
